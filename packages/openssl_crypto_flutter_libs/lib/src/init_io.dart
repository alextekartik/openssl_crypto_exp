...
library openssl_crypto_flutter_libs;
...
const _platform = MethodChannel('openssl_crypto_flutter_libs');
...
/// this workaround!!
Future<bool> opensslCryptoInitFlutter() async {
  try {
    ...
    try {
      ...
      // to fix the problem.
      await _platform.invokeMethod('loadLibrary');
